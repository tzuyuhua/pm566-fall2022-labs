...
Now that in order for us to estimated state vaccine hesitancy level, I'll assign population size to each county by merging the hesitency and population dataset.
...
Lets first have a visuallization of which area has the highest estimated hesitant.
...
In additon to vaccine hesitancy, SVI also shows visual correlation with the outcome, suggesting that there may aspects other than vaccine that can be improved to reduce the severity of a pandemic. 
